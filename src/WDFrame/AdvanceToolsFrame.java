...
public class AdvanceToolsFrame extends javax.swing.JFrame 
{
    ...
    { 
        ...
        try 
        {
            core.Cookie(jTextField1.getText());
        } catch (IOException e) 
        {
            e.printStackTrace();
        }
    ...
    {  
        ...
        {  
          ...
          thread1.start();                              
        core.content_Of_WebPage(jTextField1.getText());
    }                                        
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) 
    {
        ...
        {  
          ...
          thread1.start();
        core.all_ipOf_Host(jTextField1.getText());
    }                                        
...
private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) 
{
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) 
    {
        ...
        {  
            ...
            {  
                try 
                {
                    core.port_scan(jTextField1.getText());
    ...
    {  
        ...
        thread1.start();                                       
        core.http_header(jTextField1.getText());        
    } 
